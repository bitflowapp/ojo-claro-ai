...
class VoiceHelpCenterTest {
    ...
    fun ayudaVivaSoloPrometeFuncionesReales() {
        ...
        assertTrue(help.contains("leer la pantalla", ignoreCase = true))
    ...
    fun ayudaContextualCambiaSegunPantalla() {
        ...
        assertTrue(confirmation.contains("confirmar", ignoreCase = true))
        assertTrue(confirmation.contains("cancelar", ignoreCase = true))
        assertFalse(confirmation.contains(" sí", ignoreCase = true))
